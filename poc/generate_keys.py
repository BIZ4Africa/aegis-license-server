#!/usr/bin/env python3
"""
AEGIS License Server - Key Generation Utility

Generates an Ed25519 keypair for license signing.
Usage: python generate_keys.py [--key-id aegis-2026-01]
"""
...
def generate_keypair(key_id: str, output_dir: str = "keys"):
    ...
    # Serialize private key (PEM format, no encryption for POC)
    ...
    # Define file paths
    private_key_path = os.path.join(output_dir, f"{key_id}.private.pem")
    public_key_path = os.path.join(output_dir, f"{key_id}.public.pem")
